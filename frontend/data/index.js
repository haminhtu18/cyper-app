...
export const DiscountProductss = [
  {
    ...
    subTitle: [
      {
        name: "Dashboard",
        navlink: "dashboard",
        imgLink: "/smart-home.svg",
      },
      {
        name: "Order Management",
        navlink: "order-management",
        imgLink: "/shopping-cart.svg",
      },
      {
        name: "Customers",
        navlink: "customers",
      ...
      },
      {
        name: "Categories",
        navlink: "categories",
        imgLink: "/circle-square.svg",
      },
      {
        name: "Transaction",
        navlink: "transaction",
        imgLink: "/file-text.svg",
      },
      {
        name: "Brand",
        navlink: "brand",
    ...
    subTitle: [
      {
        name: "Add Product",
        navlink: "add-product",
        imgLink: "/add-product.svg",
      },
      {
        name: "Product List",
        navlink: "product-list",
        imgLink: "/product-list.svg",
      },
    ],
  },
  {
    ...
    subTitle: [
      {
        name: "Manage Admins",
        navlink: "manage-admins",
        imgLink: "/manage-admins.svg",
      },
      {
        name: "Admin Roles",
        navlink: "admin-roles",
...
export const productDetail = {
  ...
  cpu: { name: "A16 Bionic", cores: 6 },
  main_camera: "48-12 -12 MP",
  front_camera: "12MP",
  battery_capacity: "4323 mAh",
  images: [
    "https://i.ibb.co/HPcXMWV/Image1.png",
    "https://i.ibb.co/dWnyzNv/Image2.png",
    "https://i.ibb.co/HBywv8g/Image3.png",
    "https://i.ibb.co/0Dn1mqT/Image4.png",
  ],
  sizes: [
    {
      name: "128GB",
