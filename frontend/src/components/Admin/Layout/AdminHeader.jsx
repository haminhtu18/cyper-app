...
const AdminHeader = () => {
  ...
  return (
    <>
      <header
        className={`sticky z-20 bg-white max-h-[88px] w-full transition-all`}
      >
        <div className=" flexCenter h-full w-full">
          <div className="py-4 px-6 w-full h-full flex items-center justify-between gap-8">
            ...
            <Link to="/admin/settings" className="flex items-center gap-2">
              ...
              <p className="medium-20 hidden lg:block">Tao la Admin</p>
            </Link>
          </div>
        </div>
      </header>
